<template>
	<view class="paySu">
		...
		<view class="copyQrCode" @tap="toPath('/pages/my/classSchedule')">
			查看我的课表
		</view>
		<view class="readme">
			<view class="title">
			...
			<rich-text class="cont" :nodes="orderInfo.notice"></rich-text>
		</view>
	</view>
</template>
...
export default{
	...
	onHide() {
		// this.$store.commit('orderInfoSet',null)
		this.$store.commit('orderSchoolListSet',[])
	}
}
</script>
